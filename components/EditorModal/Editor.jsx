...
export default class Editor extends Component {
  ...
  render() {
    ...
    return (
      // <TransitionMotion styles={defStyle}>
      <div className="z_editor-background" style={styles.overlay} onMouseDown={this.props.onBgClick}>
        <div className="z_editor-center-box" onMouseDown={prevent}>

...
export default function getStyles(props, context, state) {
 ...
 // borderColor = state.isActive ? primary1Color : borderColor;
  ...
  return {
    ...
    popover: {
      // backgroundColor: menuItemStyle && menuItemStyle.backgroundColor ? menuItemStyle.backgroundColor : canvasColor,
    },
    menuHover: {
      ':hover': {
    ...
    load: {
      // fontFamily: menuItemStyle && menuItemStyle.fontFamily ? menuItemStyle.fontFamily : 'sans-serif',
      color: primary1Color,
      textAlign: 'center',
      fontSize: multiSelectStyle && multiSelectStyle.fontSize ? multiSelectStyle.fontSize : 12,
      cursor: 'pointer',
